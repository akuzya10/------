      ...
      <Container style={{ overflow: "hidden" }}>
        ...
        <div className="stock-wrapper-title">
          <div className="stock-title">
            Минимальное время посещения:
            <br /> 2 часа <br /> При заказе сауны от 7 часов действует акция
            <br /> 7+1 (8-ой час в подарок) <br />С понедельника по пятницу до
            17:00 действует скидка 30%
          </div>
          {!IS_MOBILE && (
            <svg
