      ...
      <Container style={{ overflow: "hidden" }}>
        ...
        <div className="stock-wrapper-title">
          <div className="stock-title">
            Минимальное время посещения:<br /> 2 часа <br /> При заказе сауны от 7
            часов действует акция<br /> 7+1 (8-ой час в подарок) <br />С понедельника
            по пятницу до 17:00 действует скидка 30%
          </div>
          {!IS_MOBILE && (
            <svg
        ...
        <div className="stock-wrapper-subTitle">
          ...
          <div className="stock-subTitle">
            С понедельника по четверг после 17:00 действует скидка 15% <br />
            Именинникам скидка 5% <br /> За отметку в сторис в соц сетях
            (вконтакте, телеграм, инстаграм) веник в подарок <br /> Акции
            действует на все номера!
          </div>
        </div>
        <h3 className="stock-dopInfo">
          Дополнительные услуги: веники, уголь, кальян, напитки
        </h3>
      </Container>
    </div>
  );
